...
export const MARKETING_TIERS: MarketingTierEntry[] = [
  {
    ...
    comingSoon: true,
    bullets: [
      "Guided self-serve wizard — you enter the values, we do the classification",
      "5-, 7-, 15- and 39-year schedule with full MACRS projection",
      "Downloadable PDF with methodology appendix",
      "IRS Pub 946 + TCJA/OBBBA bonus-depreciation eligibility check built in",
      "Share a read-only link with your CPA",
    ],
    limitations: ["No engineer sign-off", "Best for properties under $750k basis"],
    bestFor: "Single-family STRs, small residential rentals under $750k basis.",
    footnote: "Planning tool. Have your CPA review before filing.",
    ctaLabel: "Join the waitlist",
    ctaHref: "#diy-waitlist",
  },
  {
    id: "AI_REPORT",
