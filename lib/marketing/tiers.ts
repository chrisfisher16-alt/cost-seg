...
export const MARKETING_TIERS: MarketingTierEntry[] = [
  {
    ...
    turnaround: "Instant",
    bullets: [
      "Guided self-serve wizard: you enter basis and land value",
      "Full 40-row MACRS schedule with half-year and mid-month conventions",
      "Branded PDF with methodology appendix (Cover, Exec Summary, Asset Schedule, Appendix A–E, including the CPA filing worksheet)",
      "IRS Pub 946 plus TCJA / OBBBA bonus-depreciation eligibility check built in",
  ...
  },
  {
    ...
    priceNote: "per property",
    tagline: "The full modeling report, generated end-to-end in under 30 minutes.",
    turnaround: "Delivered in under 30 minutes",
    badge: { label: "Most popular", tone: "primary" },
    featured: true,
    bullets: [
      "Everything in DIY, plus the full AI pipeline",
      ...
      "Engineered-study-class PDF: cover, TOC, MACRS schedule, methodology, and CPA filing worksheet",
    ],
